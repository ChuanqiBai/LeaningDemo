...
type Filter struct {
	...
	MinCpiCores uint32  `protobuf:"varint,2,opt,name=min_cpi_cores,json=minCpiCores,proto3" json:"min_cpi_cores,omitempty"`
...
func (x *Filter) GetMinCpiCores() uint32 {
	if x != nil {
		return x.MinCpiCores
	}
	return 0
}
...
var file_filter_message_proto_rawDesc = []byte{
	...
	0x55, 0x73, 0x64, 0x12, 0x22, 0x0a, 0x0d, 0x6d, 0x69, 0x6e, 0x5f, 0x63, 0x70, 0x69, 0x5f, 0x63,
	0x6f, 0x72, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x6d, 0x69, 0x6e, 0x43,
	0x70, 0x69, 0x43, 0x6f, 0x72, 0x65, 0x73, 0x12, 0x1e, 0x0a, 0x0b, 0x6d, 0x69, 0x6e, 0x5f, 0x63,
