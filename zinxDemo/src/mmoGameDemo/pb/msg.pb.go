...
type BroadCast struct {
	...
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` //TP=1世界聊天 =2玩家位置 3-动作 4移动后的位置信息
...
type BroadCast_Content struct {
	Content string `protobuf:"bytes,3,opt,name=Content,proto3,oneof"` //玩家的聊天消息
}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x01, 0x50, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2e, 0x2f,
